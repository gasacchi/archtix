...
/* font color */
static const char col_pink[]       = "#ff7c7c";
/* current tag and window font color */
static const char col_navy[]       = "#21243d";
/* top bar second color */
static const char col_bar_pink[]        = "#ff7c7c";
static const char *colors[][3]      = {
  /*               fg         bg         border   */
  [SchemeNorm] = { col_pink, col_background, col_cream },
  [SchemeSel]  = { col_navy, col_bar_pink,  col_bar_pink  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_background, "-nf", col_pink, "-sb", col_bar_pink, "-sf", col_navy, NULL };
